...
function changeGameStatud(character) {
  if (GameStatus = "start" && rightWristX != "" && gameConfig.status === "start") {
    world_start.play();
...
function manualControl(character) {
  ...
  if (character.live) {
    if (control1 == "nose") {
      ...
      if (rightWristX > 250 && rightWristX < 350 && rightWristY > 200) {
...
function jumping(character) {
  if (control1 == "nose") {
    if ((rightWristY < 200 && character.live) || (touchIsDown && character.live)) {
